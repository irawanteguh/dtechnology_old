    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header pb-0 border-0 justify-content-end">
                <div class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary " data-bs-toggle="tooltip" data-bs-dismiss="click" title="" data-bs-original-title="Edit Position"   id="kt_modal_view_event_edit"><span class="svg-icon svg-icon-2"><i class="bi bi-pencil-square"></i></span></div>
