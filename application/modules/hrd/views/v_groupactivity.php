<input type="hidden" id="positionid-mapping" name="positionid-mapping">
        ...
        <div class="card card-flush">
            <div class="card-header pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Position</span>
        ...
        <div class="card card-flush">
            <div class="card-header pt-5">
                <h3 class="card-title align-items-start flex-column">
                    ...
                    <span class="text-muted mt-1 fw-bold fs-7" id="headerlistactivity">List Activity :</span>
                </h3>
                <div class="card-toolbar">
                </div>
            </div>
            <div class="card-body">
                <div id="kt_docs_search_handler_activity" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="true" data-kt-search-layout="inline" data-kt-search="true" class="">
                    ...
                    <div data-kt-search-element="results">
                        <div class="mh-450px scroll-y me-n5 pe-5" id="listactivity"></div>
                    </div>
                </div>
            </div>
        </div>
